...
public class TagWriter {
	 ...
	 */
	public TagWriter(JspContext jspContext) {
		//Assert.notNull(pageContext, "PageContext must not be null");
		this.writer = new SafeWriter(jspContext);
	}
	...
	private static final class SafeWriter {
		...
		public SafeWriter(JspContext jspContext) {
		...
		private Writer getWriterToUse() {
			return (this.jspContext != null ? this.jspContext.getOut() : this.writer);
		}
	}
